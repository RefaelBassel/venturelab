...
כתוב **בגוף ראשון רבים (אנחנו)**, מנקודת מבט הצוות — כאילו התלמידים עצמם מספרים על המיזם בערב התוצרים. למשל: "מהעולם למדנו ש...", "אנחנו מציעים...", "הצבנו לעצמנו יעד...". לעולם לא בגוף שלישי ("הצוות למד", "הם מציעים").
...
- highlights: שש נקודות, כל אחת על שלב אחר, **כולן בגוף ראשון רבים**. כל נקודה: **משפט עד שניים** — תמציתי, אבל עם מספיק בשר כדי להבין לעומק (לא רק כותרת חטופה). אל תאריך מעבר לכך. אם באמת אין מידע לשלב מסוים — החזר מחרוזת ריקה ("") לאותו שדה:
  - pain: "הכאב" — מדוע נולד המיזם: המצוקה האישית או החברתית שהציתה אותנו ולמי היא כואבת, במשפט-שניים אנושיים ונוגעים. מתוך הבעיה והתובנות.
  - proposal: "ההצעה" — הפתרון שאנחנו מציעים כמענה לכאב ומה הופך אותו לייחודי, במשפט-שניים ברורים. הצעת הערך של המיזם.
  - world: "מחקר שטח" — מה גילינו מהעולם או מהריאיון, והתובנה שהפנמנו לתוך המיזם (מה עובד / מה חסר).
  - approach: "תוכנית הפעולה" — איך אנחנו מתכננים להוציא את המיזם לפועל — הצעד המרכזי או שניים בדרך.
  - budget: "תקציב" — כמה המיזם צפוי לעלות ועל מה עיקר ההוצאה. אם הוזן סכום — ציין אותו (למשל "כ-1,500 ₪, בעיקר ל...").
  - goals: "יעדים" — היעד המרכזי שהצבנו לעצמנו וכיצד נדע שהצלחנו (מדד ההצלחה).
