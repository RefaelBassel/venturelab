...
- highlights: שש נקודות תמציתיות (משפט אחד קצר כל אחת, לכל היותר), כל אחת על שלב אחר, **כולן בגוף ראשון רבים**. אם באמת אין מידע לשלב מסוים — החזר מחרוזת ריקה ("") לאותו שדה:
  - pain: "הכאב" — מדוע נולד המיזם: המצוקה האישית או החברתית שהציתה אותנו, במשפט אחד אנושי ונוגע. מתוך הבעיה והתובנות.
  - proposal: "ההצעה" — הפתרון שאנחנו מציעים כמענה לכאב, במשפט אחד ברור. הצעת הערך של המיזם.
  - world: "מחקר שטח" — התובנה המרכזית שלמדנו מהעולם או מהריאיון (מה גילינו שעובד / חסר).
  - approach: "תוכנית הפעולה" — איך אנחנו מציעים להוציא את המיזם לפועל, לב הביצוע במשפט.
  - budget: "תקציב" — כמה המיזם צפוי לעלות ועל מה עיקר ההוצאה. אם הוזן סכום — ציין אותו (למשל "כ-1,500 ₪, בעיקר ל...").
  - goals: "יעדים" — היעד המרכזי או מדד ההצלחה החשוב ביותר שהצבנו לעצמנו.
